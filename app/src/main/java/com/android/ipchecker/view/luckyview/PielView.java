package com.android.ipchecker.view.luckyview;
...
public class PielView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        float sweepAngle = 360.0f / (mLuckyItemList.size() * 1.0f);
    ...
    private void drawImage(Canvas canvas, float tmpAngle, Bitmap bitmap) {
        ...
        float angle = (float) ((tmpAngle + 360.0f / (mLuckyItemList.size() * 1.0f) / 2f) * Math.PI / 180f);
    ...
    private void drawText(Canvas canvas, float tmpAngle, float sweepAngle, String mStr) {
        ...
        canvas.drawTextOnPath(mStr, path, hOffset, vOffset-60, mTextPaint);
    }
    ...
    private float getAngleOfIndexTarget() {
        ...
        return (360f / mLuckyItemList.size()) * (tempIndex * 1.0f);
    }
    ...
    public void rotateTo(int index) {
        ...
        mTargetIndex = index;
        setRotation(0);
        float targetAngle = 360f * mRoundOfNumber + 270f - getAngleOfIndexTarget()*1.0f + (360f / mLuckyItemList.size()) / 2.0f;
        animate()
                .setInterpolator(new DecelerateInterpolator())
                .setDuration(mRoundOfNumber * 300 + 1500L)
